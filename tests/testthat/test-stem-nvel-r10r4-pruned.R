pruned_r10r4_exclusions <- list(r10_taper = list(diameter = c(
...
test_that("pruned double Region 10 and Region 4 fixtures agree", {
  ...
  for (family in c("r10_taper", "r4_driver")) {
    .check_r10r4_fixture(
      .r10r4_fixture_path(root, family, "double"), family,
      "double", pruned_r10r4_exclusions[[family]]
    )
  }
})
...
test_that("pruned single Region 10 and Region 4 fixtures agree", {
  ...
  for (family in c("r10_taper", "r4_driver")) {
    ...
    .check_r10r4_fixture(
      .r10r4_fixture_path(root, family, "single"), family, "single", single_exclusions,
      double
    )
  }
})
